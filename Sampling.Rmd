 ...
 * Estimate of the prevalence or mean & STDev of the key indicator (e.g. 30% retunr intention). Prevalence is the total number of cases for a variable of interest that is **typically binary** within a population divided by its total population. Mean is the expected value of  a variable of interest that is **typically continuous** within a prescribed range for a given population (e.g. expenditure per case) 
...
Stratified sampling can be performed with R. [Tutorial scripts are avaialble here](https://github.com/unhcr-mena/stratified-sampling).
