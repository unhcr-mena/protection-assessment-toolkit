 ...
 * Ensure that all topics of interest are well covered
 * Check that all required questions to calculate the indicators and vulnerability profile (severity, magnitude, criticality) are included
 * Deliver quickly 
